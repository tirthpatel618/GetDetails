...
using this extension, simply keep everything loaded on the browser, and on a click of a button, 
...
open a new folder and copy all of these files!
Modify the config.template.js with your details and change it's name to config.js. 
(if you want add any other details add them to the config file and just change the popup.js file accordingly)

Load the unpacked extension to chrome extensions and enjoy!

PS. Make sure you keep it private 
